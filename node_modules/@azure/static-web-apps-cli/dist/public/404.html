...
<html lang="en">
  ...
  <body>
    ...
    <footer>
      <div>Azure Static Web Apps emulator (<a rel="noopener noreferrer" target="_blank" href="https://github.com/Azure/static-web-apps-cli/commit/11fe14d">main+sha.11fe14d</a>)</div>
      <nav>
        <ul>
