  ...
  return (
    ...
    <div className={`${styles.contato}`} >
     ...
     <svg viewBox="0 0 24 24" width="30" height="30" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <input type="tel" name="telefone" value={maskPhone(visitor.telefone)} className={visitor.telefone ? "" : `${errors.telefone && `${styles.invalid}`}`} onChange={(e) => handleChange(e)} placeholder="Digite o seu número de telefone" />
          ...
          <svg fill="rgb(0, 178, 239)" viewBox="0 0 24 24" width="30" height="30" xmlns="http://www.w3.org/2000/svg">
          ...
          <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="rgb(0, 178, 239)" width="30" height="30"> <path d=" M15 3c.552 0 1 .448 1 1v2h5c.552 0 1 .448 1 1v13c0 .552-.448 1-1 1H3c-.552 0-1-.448-1-1V7c0-.552.448-1 1-1h5V4c0-.552.448-1 1-1h6zm1 5H8v11h8V8zM4 8v11h2V8H4zm10-3h-4v1h4V5zm4 3v11h2V8h-2z" /></svg>
          ...
          <div className={`${styles.inputIcon}`}>
          <svg viewBox="0 0 24 24" fill="none" width="30" height="30" xmlns="http://www.w3.org/2000/svg"> <path d="M12 21C15.5 17.4 19 14.1764 19 10.2C19 6.22355 15.866 3 12 3C8.13401 3 5 6.22355 5 10.2C5 14.1764 8.5 17.4 12 21Z M12 13C13.6569 13 15 11.6569 15 10C15 8.34315 13.6569 7 12 7C10.3431 7 9 8.34315 9 10C9 11.6569 10.3431 13 12 13Z" stroke="rgb(0, 178, 239)"  strokeWidth="2" /></svg>
          ...
          <textarea name="mensagem" value={visitor.mensagem} className={visitor.mensagem ? "" : `${errors.mensagem && `${styles.invalid}`}`} placeholder="Digite a mensagem aqui" onChange={(e) => handleChange(e)}>
          </textarea>
