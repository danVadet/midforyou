...
const Contact = (props: IContactProps) => {
  ...
  const validate = (visitor: Visitor) => {
    ...
    if (!visitor.nome) {
      errors.nome = `${`${(language === "pt" && `${multiLang.pt.fullNameRequiredContact}`) || (language === "en"  && `${multiLang.en.fullNameRequiredContact}`) ||( language === "es" && `${multiLang.es.fullNameRequiredContact}`)}`}`;
    }

    if (!visitor.telefone) {
      errors.telefone = `${`${(language === "pt" && `${multiLang.pt.phoneRequiredContact}`) || (language === "en"  && `${multiLang.en.phoneRequiredContact}`) ||( language === "es" && `${multiLang.es.phoneRequiredContact}`)}`}`;
    }
    ...
    if (!visitor.nomeEmpresa) {
      errors.nomeEmpresa = `${`${(language === "pt" && `${multiLang.pt.companyNameRequiredContact}`) || (language === "en"  && `${multiLang.en.companyNameRequiredContact}`) ||( language === "es" && `${multiLang.es.companyNameRequiredContact}`)}`}`;
    }

    if (!visitor.ramoAtividade) {
      errors.ramoAtividade = `${`${(language === "pt" && `${multiLang.pt.ramoAividadeRequiredContact}`) || (language === "en"  && `${multiLang.en.ramoAividadeRequiredContact}`) ||( language === "es" && `${multiLang.es.ramoAividadeRequiredContact}`)}`}`;
    }

    if (!visitor.local) {
      errors.local = `${`${(language === "pt" && `${multiLang.pt.localRequiredContact}`) || (language === "en"  && `${multiLang.en.localRequiredContact}`) ||( language === "es" && `${multiLang.es.localRequiredContact}`)}`}`;
    }

    if (!visitor.mensagem) {
      errors.mensagem = `${`${(language === "pt" && `${multiLang.pt.messageRequiredContact}`) || (language === "en"  && `${multiLang.en.messageRequiredContact}`) ||( language === "es" && `${multiLang.es.messageRequiredContact}`)}`}`;
    }
      ...
      <div className={`${styles.contactComponent}`}>
        <div className={`${styles.contactImage}`} >
          ...
          <div className={`${styles.contactLegend}`}>
            <span>{`${`${(language === "pt" && `${multiLang.pt.imageLegend}`) || (language === "en"  && `${multiLang.en.imageLegend}`) ||( language === "es" && `${multiLang.es.imageLegend}`)}`}`}</span>

          </div>

          <div className={`${styles.contactContainer}`}>
            <h1>{`${`${(language === "pt" && `${multiLang.pt.contactTitle}`) || (language === "en"  && `${multiLang.en.contactTitle}`) ||( language === "es" && `${multiLang.es.contactTitle}`)}`}`}</h1>
            ...
            {sentData ? <>  {message && <Message type='sucess' message='Mensagem enviada com sucesso, e até em breve faremos contato.' />} </> : <form onSubmit={(e) => handleSubmit(e)} className={`${styles.formContainer}`}>
              ...
              <div className={`${styles.inputIcon}`}>
                ...
                <input type="text" name="nome" value={visitor.nome} className={visitor.nome ? "" : `${errors.nome && `${styles.invalid}`}`} onChange={(e) => handleChange(e)} placeholder={`${`${(language === "pt" && `${multiLang.pt.enterFullName}`) || (language === "en"  && `${multiLang.en.enterFullName}`) ||( language === "es" && `${multiLang.es.enterFullName}`)}`}`} />
              ...
              <div className={`${styles.inputIcon}`}>
                ...
                <input type="tel" name="telefone" value={maskPhone(visitor.telefone)} className={visitor.telefone ? "" : `${errors.telefone && `${styles.invalid}`}`} onChange={(e) => handleChange(e)} placeholder={`${`${(language === "pt" && `${multiLang.pt.enterPhone}`) || (language === "en"  && `${multiLang.en.enterPhone}`) ||( language === "es" && `${multiLang.es.enterPhone}`)}`}`} />
              ...
              <div className={`${styles.inputIcon}`}>
                ...
                <input type="text" name="email" value={visitor.email} className={visitor.email && emailParrent.test(visitor.email) ? "" : `${errors.email && `${styles.invalid}`}`} placeholder={`${`${(language === "pt" && `${multiLang.pt.enterEmail}`) || (language === "en"  && `${multiLang.en.enterEmail}`) ||( language === "es" && `${multiLang.es.enterEmail}`)}`}`} onChange={(e) => handleChange(e)} />
              ...
              <div className={`${styles.inputIcon}`}>
                ...
                <input type="text" name="nomeEmpresa" value={visitor.nomeEmpresa} className={visitor.nomeEmpresa ? "" : `${errors.nomeEmpresa && `${styles.invalid}`}`} placeholder={`${`${(language === "pt" && `${multiLang.pt.enterCompanyName}`) || (language === "en"  && `${multiLang.en.enterCompanyName}`) ||( language === "es" && `${multiLang.es.enterCompanyName}`)}`}`} onChange={(e) => handleChange(e)} />
              ...
              <label className={`${styles.inputIcon}`}>
                ...
                <input type="text" name="ramoAtividade" value={visitor.ramoAtividade} className={visitor.ramoAtividade ? "" : `${errors.ramoAtividade && `${styles.invalid}`}`} placeholder={`${`${(language === "pt" && `${multiLang.pt.enterRamoAtividade}`) || (language === "en"  && `${multiLang.en.imageLegend}`) ||( language === "es" && `${multiLang.es.enterRamoAtividade}`)}`}`} onChange={(e) => handleChange(e)} />
              ...
              <div className={`${styles.inputIcon}`}>
                ...
                <input type="text" name="local" value={visitor.local} className={visitor.local ? "" : `${errors.local && `${styles.invalid}`}`} placeholder={`${`${(language === "pt" && `${multiLang.pt.enterLocal}`) || (language === "en"  && `${multiLang.en.enterLocal}`) ||( language === "es" && `${multiLang.es.enterLocal}`)}`}`} onChange={(e) => handleChange(e)} />
              ...
              <div className={`${styles.inputIcon}`}>
                ...
                <textarea name="mensagem" value={visitor.mensagem} className={visitor.mensagem ? "" : `${errors.mensagem && `${styles.invalid}`}`} placeholder={`${`${`${(language === "pt" && `${multiLang.pt.enterMessage}`) || (language === "en"  && `${multiLang.en.enterMessage}`) ||( language === "es" && `${multiLang.es.enterMessage}`)}`}`}`} onChange={(e) => handleChange(e)}>
                </textarea>
              ...
              {sendingData ? <button className={`${styles.sendingButton}`}>{`${`${(language === "pt" && `${multiLang.pt.buttonSending}`) || (language === "en"  && `${multiLang.en.buttonSending}`) ||( language === "es" && `${multiLang.es.buttonSending}`)}`}`} <svg className={styles.spinner} viewBox="0 0 50 50"><circle className={styles.path} cx="25" cy="25" r="20" fill="none" strokeWidth="5"></circle></svg></button> : <button className={`${styles.sendButton}`} >{`${`${(language === "pt" && `${multiLang.pt.buttonSend}`) || (language === "en"  && `${multiLang.en.buttonSend}`) ||( language === "es" && `${multiLang.es.buttonSend}`)}`}`}</button>}
