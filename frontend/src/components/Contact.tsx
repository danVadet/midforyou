      ...
      <div className={`${styles.contactContainer}`}>
        ...
        <form onSubmit={(e) => handleSubmit(e)} className={`${styles.formContainer}`}>
          <svg viewBox="0 0 24 24" className={styles.userIcon} width="30" height="30" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d=" M16 7C16 9.20914 14.2091 11 12 11C9.79086 11 8 9.20914 8 7C8 4.79086 9.79086 3 12 3C14.2091 3 16 4.79086 16 7Z M12 14C8.13401 14 5 17.134 5 21H19C19 17.134 15.866 14 12 14Z" stroke="rgb(0, 178, 239)" strokeWidth="2" />
          </svg>
          ...
          <svg viewBox="0 0 24 24" className={styles.emailIcon} width="30" height="30" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M3 8L8.44992 11.6333C9.73295 12.4886 10.3745 12.9163 11.0678 13.0825C11.6806 13.2293 12.3194 13.2293 12.9322 13.0825C13.6255 12.9163 14.2671 12.4886 15.5501 11.6333L21 8M6.2 19H17.8C18.9201 19 19.4802 19 19.908 18.782C20.2843 18.5903 20.5903 18.2843 20.782 17.908C21 17.4802 21 16.9201 21 15.8V8.2C21 7.0799 21 6.51984 20.782 6.09202C20.5903 5.71569 20.2843 5.40973 19.908 5.21799C19.4802 5 18.9201 5 17.8 5H6.2C5.0799 5 4.51984 5 4.09202 5.21799C3.71569 5.40973 3.40973 5.71569 3.21799 6.09202C3 6.51984 3 7.07989 3 8.2V15.8C3 16.9201 3 17.4802 3.21799 17.908C3.40973 18.2843 3.71569 18.5903 4.09202 18.782C4.51984 19 5.07989 19 6.2 19Z" stroke="rgb(0, 178, 239)"  strokeWidth="2" />
          </svg>
          ...
          <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="rgb(0, 178, 239)" width="30" height="30" className={styles.suitcaseIcon}  > <path d=" M15 3c.552 0 1 .448 1 1v2h5c.552 0 1 .448 1 1v13c0 .552-.448 1-1 1H3c-.552 0-1-.448-1-1V7c0-.552.448-1 1-1h5V4c0-.552.448-1 1-1h6zm1 5H8v11h8V8zM4 8v11h2V8H4zm10-3h-4v1h4V5zm4 3v11h2V8h-2z" /></svg>
          ...
          <svg viewBox="0 0 24 24" fill="none" width="30" height="30" className={styles.localIcon} xmlns="http://www.w3.org/2000/svg"> <path d="M12 21C15.5 17.4 19 14.1764 19 10.2C19 6.22355 15.866 3 12 3C8.13401 3 5 6.22355 5 10.2C5 14.1764 8.5 17.4 12 21Z M12 13C13.6569 13 15 11.6569 15 10C15 8.34315 13.6569 7 12 7C10.3431 7 9 8.34315 9 10C9 11.6569 10.3431 13 12 13Z" stroke="rgb(0, 178, 239)"  strokeWidth="2" /></svg>
